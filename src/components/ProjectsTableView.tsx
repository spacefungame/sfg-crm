        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '1200px', fontSize: '12px' }}>
          <thead>
            <tr style={{ backgroundColor: '#F0F4F8', borderBottom: '2px solid #D0DCE5', textAlign: 'left' }}>
              ...
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', width: '70px' }}>Arrivée</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', width: '70px' }}>Départ</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', minWidth: '140px' }}>Activités</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', minWidth: '120px' }}>Catering</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', minWidth: '120px' }}>Boissons</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', minWidth: '120px' }}>Matériel</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', width: '100px' }}>Paiement</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', borderRight: '1px solid #D0DCE5', padding: '10px 6px', width: '80px' }}>Devis (€)</th>
              <th style={{ position: 'sticky', top: 0, zIndex: 10, backgroundColor: '#F0F4F8', padding: '10px 6px', minWidth: '140px' }}>Relance</th>
            </tr>
          </thead>
          <tbody>
            {(() => {
